...
function latexToMarkup(latex, mf) {
  var parse = _parser.default.parseTokens(_lexer.default.tokenize(latex), 'math', null, mf.config.macros);
...
function showPopoverWithLatex(mf, latex, displayArrows) {
  ...
  var command_shortcuts = _editorShortcuts.default.forCommand(command);
