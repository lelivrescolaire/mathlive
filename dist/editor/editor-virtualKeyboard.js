...
var _color2 = _interopRequireDefault(require("../core/color.js"));
...
function latexToMarkup(latex, arg, mf) {
  ...
  var parse = _parser.default.parseTokens(_lexer.default.tokenize(latex), 'math', arg, mf.config.macros);
  ...
  var wrapper = _span.default.makeSpan([topStrut, bottomStrut, base], 'ML__mathlive');
...
function makeKeyboardToolbar(mf, keyboardIDs, currentKeyboard) {
    ...
    try {
      for (var _iterator = keyboardList[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        if (keyboards[keyboard].tooltip) {
          result += "data-tooltip='" + (0, _l10n.l10n)(keyboards[keyboard].tooltip) + "' ";
  ...
  result += "\n        <div class='right'>\n            <div class='action'\n                data-command='\"copyToClipboard\"'\n                data-tooltip='".concat((0, _l10n.l10n)('tooltip.copy to clipboard'), "' data-placement='top' data-delay='1s'>\n                <svg><use xlink:href='#svg-copy' /></svg>\n            </div>\n            <div class='action disabled'\n                data-command='\"undo\"'\n                data-tooltip='").concat((0, _l10n.l10n)('tooltip.undo'), "' data-placement='top' data-delay='1s'>\n                <svg><use xlink:href='#svg-undo' /></svg>\n            </div>\n            <div class='action disabled'\n                data-command='\"redo\"'\n                data-tooltip='").concat((0, _l10n.l10n)('tooltip.redo'), "' data-placement='top' data-delay='1s'>\n                <svg><use xlink:href='#svg-redo' /></svg>\n            </div>\n        </div>\n    ");
...
function make(mf, theme) {
  ...
  try {
    for (var _iterator4 = _color2.default.LINE_COLORS[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
  ...
  try {
    for (var _iterator5 = _color2.default.AREA_COLORS[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
    ...
    for (var _iterator6 = keyboardList[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
      ...
      try {
        for (var _iterator7 = keyboardLayers[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
          ...
          if (_typeof(layers[layer]) === 'object') {
