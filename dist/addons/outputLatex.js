...
var _color = _interopRequireDefault(require("../core/color.js"));
...
function latexifyArray(parent, properties, atoms, expandMacro) {
  ...
  if (prop === 'color' && atoms[0].color && atoms[0].color !== 'none' && (!parent || parent.color !== atoms[0].color)) {
    prefix = '\\textcolor{' + _color.default.colorToString(atoms[0].color) + '}{';
    suffix = '}';
  }
  ...
  if (prop === 'backgroundColor' && atoms[0].backgroundColor && atoms[0].backgroundColor !== 'none' && (!parent || parent.backgroundColor !== atoms[0].backgroundColor)) {
    prefix = '\\colorbox{' + _color.default.colorToString(atoms[0].backgroundColor) + '}{';
    suffix = '}';
  }
...
_mathAtom.default.MathAtom.prototype.toLatex = function (expandMacro) {
      ...
      if (command === '\\bbox') {
        ...
        if (isFinite(this.padding) || typeof this.border !== 'undefined' || typeof this.backgroundcolor !== 'undefined') {
          ...
          if (this.backgroundcolor) {
            bboxParams.push(_color.default.colorToString(this.backgroundcolor));
          }
        ...
        if (this.framecolor) {
          result += "{".concat(_color.default.colorToString(this.framecolor), "}");
        }

        if (this.backgroundcolor) {
          result += "{".concat(_color.default.colorToString(this.backgroundcolor), "}");
        }
    ...
    case 'enclose':
      ...
      if (command === '\\enclose') {
        ...
        if (this.backgroundcolor && this.backgroundcolor !== 'transparent') {
          style += sep + 'mathbackground="' + _color.default.colorToString(this.backgroundcolor) + '"';
          sep = ',';
        }
        ...
        if (this.strokeWidth !== 1 || this.strokeStyle !== 'solid') {
          ...
          style += sep + 'mathcolor="' + _color.default.colorToString(this.strokeColor) + '"';
          sep = ',';
        }
