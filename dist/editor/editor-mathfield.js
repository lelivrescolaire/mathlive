...
var _editorEditableMathlist = _interopRequireDefault(require("./editor-editableMathlist.js"));

var _editorMathpath = _interopRequireDefault(require("./editor-mathpath.js"));

var _editorKeyboard = _interopRequireDefault(require("./editor-keyboard.js"));

var _editorUndo = _interopRequireDefault(require("./editor-undo.js"));

var _editorShortcuts = _interopRequireDefault(require("./editor-shortcuts.js"));

var _editorPopover = _interopRequireDefault(require("./editor-popover.js"));

var _editorVirtualKeyboard = _interopRequireDefault(require("./editor-virtualKeyboard.js"));

var _graphemeSplitter = _interopRequireDefault(require("../core/grapheme-splitter.js"));

var _outputASCIIMath = require("./outputASCIIMath.js");

var _l10n = require("./l10n.js");

require("../addons/outputLatex.js");

require("../addons/outputMathML.js");

require("../addons/maston.js");

require("../addons/outputSpokenText.js");
...
function MathField(element, config) {
  ...
  if (this.config.virtualKeyboardMode === 'manual') {
    markup += "<button class=\"ML__virtual-keyboard-toggle\" data-tooltip=\"".concat((0, _l10n.l10n)('tooltip.toggle virtual keyboard'), "\">"); // data-tooltip='Toggle Virtual Keyboard'
...
function _onAnnounce(target, command, oldMathlist, atomsToSpeak) {
  ...
  if (command === 'plonk') {
    ...
    target.accessibleNode.innerHTML = '<math xmlns="http://www.w3.org/1998/Math/MathML">' + _mathAtom.default.toMathML(target.mathlist.root, target.config) + '</math>';
...
MathField.prototype._showKeystroke = function (keystroke) {
  ...
  if (vb && this.keystrokeCaptionVisible) {
    ...
    vb.innerHTML = '<span>' + (_editorShortcuts.default.stringify(keystroke) || keystroke) + '</span>' + vb.innerHTML;
...
MathField.prototype._render = function (renderOptions) {
  ...
  this.accessibleNode.innerHTML = "<math xmlns='http://www.w3.org/1998/Math/MathML'>" + _mathAtom.default.toMathML(this.mathlist.root, this.config) + "</math>"; //this.ariaLiveText.textContent = "";
  //
...
MathField.prototype.insert_ = MathField.prototype.insert = MathField.prototype.$insert = function (s, options) {
...
MathField.prototype._attachButtonHandlers = function (el, command) {
  ...
  on(el, 'mousedown touchstart:passive', function (ev) {
    if (ev.type !== 'mousedown' || ev.buttons === 1) {
      ...
      if (ev.type === 'touchstart') touchID = ev.changedTouches[0].identifier; // Parse the JSON to get the command (and its optional arguments)
...
MathField.prototype.showAlternateKeys_ = function (keycap, altKeys) {
  ...
  _editorVirtualKeyboard.default.makeKeycap(this, altContainer.getElementsByTagName('li'), 'performAlternateKeys');
  ...
  if (position) {
    ...
    var top = (position.top - altContainer.clientHeight + 5).toString() + 'px';
...
MathField.prototype.toggleVirtualKeyboard_ = function (theme) {
  ...
  if (this.virtualKeyboardVisible) {
    if (this.virtualKeyboard) {
      ...
      this.virtualKeyboard = _editorVirtualKeyboard.default.make(this, theme); // Let's make sure that tapping on the keyboard focuses the field
...
MathField.prototype.$applyStyle = MathField.prototype.applyStyle_ = function (style) {
  this._resetKeystrokeBuffer();
  ...
  if (this.mathlist.isCollapsed()) {
    ...
    this.style = _objectSpread({}, this.style, style); // This style will be used the next time an atom is inserted
  } else {
...
MathField.prototype.keystroke = MathField.prototype.$keystroke = function (keys, evt) {
...
MathField.prototype.typedText = MathField.prototype.$typedText = function (text) {
...
MathField.prototype.setConfig = MathField.prototype.$setConfig = function (conf) {
  if (!this.config) {
    this.config = {
      smartFence: true,
  ...
  this.config = _objectSpread({}, this.config, conf);
  ...
  this.config.macros = Object.assign({}, _definitions.default.MACROS, this.config.macros); // Validate the namespace (used for `data-` attributes)
  ...
  _l10n.l10n.locale = this.config.locale || _l10n.l10n.locale;

  _l10n.l10n.merge(this.config.strings);
  ...
  }[_l10n.l10n.locale.substring(0, 2)] || 'qwerty'; // Possible keypress sound feedback
...
MathField.prototype.speak_ = function (amount, speakOptions) {
  ...
  var text = _mathAtom.default.toSpeakableText(atoms, options);
