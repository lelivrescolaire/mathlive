...
function renderMathInElement(element, options) {
  ...
  options.macros = options.macros || _definitions.default.MACROS;

  _autoRender.default.renderMathInElement(getElement(element), options);
}
...
function revertToOriginalContent(element, options) {
  ...
  if (element instanceof _editorMathfield.default.MathField) {
